...
class CaixaMercado(QWidget):
    ...
    def __init__(self):
        ...
        self.setWindowTitle("Aplicativo de Compras")
        ...
        labelColEsq = QLabel()
        labelColEsq.setStyleSheet("QLabel{background-color:#0091ea;}")
        labelColEsq.setFixedWidth(800)
 
        labelColDir = QLabel()
        labelColDir.setStyleSheet("QLabel{background-color:#0091ea}")
        labelColEsq.setFixedWidth(800)
       
        labelLogo = QLabel()
        labelLogo.setPixmap(QPixmap("mercadoshops.png"))
